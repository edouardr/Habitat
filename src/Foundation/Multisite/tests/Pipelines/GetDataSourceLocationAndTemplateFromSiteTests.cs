namespace Sitecore.Foundation.Multisite.Tests.Pipelines
{
    ...
    using Sitecore.Foundation.Multisite.Infrastructure.Pipelines;
    ...
    public class GetDatasourceLocationAndTemplateFromSiteTests
    {
        ...
        [Theory]
        [AutoDbData]
        public void Process_DatasourceProviderIsNotNull_SourcesAndTemplateAreSet(IDatasourceProvider provider, IDatasourceConfigurationService service, DbItem renderingItem, Db db, string settingName, Item[] sources, Item sourceTemplate)
        {
            ...
            service.GetSiteDatasourceConfigurationName(Arg.Any<string>()).Returns("N/A");
            service.IsSiteDatasourceLocation(Arg.Any<string>()).Returns(true);
            ...
            var processor = new GetDatasourceLocationAndTemplateFromSite(provider, service);
            var args = new GetRenderingDatasourceArgs(rendering);
            processor.Process(args);
